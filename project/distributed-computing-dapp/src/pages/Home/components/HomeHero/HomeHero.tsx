    ...
    <div className={heroContainerClasses}>
      <div className={styles.heroSectionTop}>
        <div className={styles.heroSectionTopContent}>
          <h1 className={styles.heroTitle}>Distributed Computing Power</h1>

          <p className={styles.heroDescription}>
            The place where you can contribute your unused computing power to
            distributed computing tasks and get rewarded in return.
          </p>
        </div>
